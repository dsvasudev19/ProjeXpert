...
const personalTodoController = require('../../controllers/admin/personalTodoController');
...
router.patch('/:id/complete', authenticateUser, personalTodoController.markAsComplete);
