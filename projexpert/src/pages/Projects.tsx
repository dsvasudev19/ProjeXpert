...
import { FolderGit2, CheckCircle, PauseCircle, Clock, Plus, Users, FileText, Bug, ListTodo, ChevronDown, ChevronUp, AlertCircle } from 'lucide-react';
...
const Projects = () => {
  ...
  const projects = [
    ...
    { id: 2, name: 'Project Beta', status: 'on-hold', members: [], tasks: [], files: 5, bugs: [] },
    { id: 3, name: 'Project Gamma', status: 'completed', members: [], tasks: [], files: 10, bugs: [] },
  ];
      ...
      <div className="p-6 mb-16">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-2xl font-bold text-gray-800">{selectedProject.members.length}</p>
          </div>
          ...
          >
            ...
            <p className="text-2xl font-bold text-gray-800">{selectedProject.files}</p>
          </div>
